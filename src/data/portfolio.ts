...
export const projects: ProjectItem[] = [
  {
    ...
    subtitle: 'Radio AIDL 升级 + 搜网 / 数据业务高优故障攻坚',
    period: '2024.03 — 至今',
    stack: ['Android Framework', 'Radio AIDL', 'Telephony', '搜网', '数据业务'],
    situation:
      '头部客户新一代终端产品需要完成通信性能升级与 ROM 适配，存量版本存在搜网、数据业务等核心痛点，直接影响量产测试与版本交付质量。',
    task:
      '负责 Radio 服务 AIDL 升级与通信模块兼容性适配，同时攻坚开机驻网慢、5G 数据断连等高优先级问题，保障客户产品按节点通过量产测试。',
    action:
      '梳理 30+ 原有 Radio 接口逻辑，逐项完成 AIDL 兼容性适配；围绕搜网、数据业务建立问题复现、日志分析、模块归因、修复验证闭环；对开机驻网慢与 5G 数据断连问题进行专项攻坚。',
    result:
      '提前 1 周完成全部开发与验证工作，支撑客户产品顺利通过量产测试；累计解决高优先级通信故障 15+，多次获得部门季度优秀项目表彰。',
    metrics: [
      { label: 'Radio 接口梳理', value: '30+', delta: 'AIDL 兼容适配' },
      { label: '高优故障攻坚', value: '15+', delta: '搜网 / 数据业务' },
      { label: '交付节点', value: '提前 1 周', delta: '开发与验证完成' },
      { label: '项目认可', value: '季度优秀', delta: '多次表彰' },
    ],
    snippets: [
      {
        lang: 'java',
